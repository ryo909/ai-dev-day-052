import './style.css';
const PROFILE = {"day":"Day052","title":"Handoff Gap Checker","display_name_ja":"引き継ぎ抜け見張り","one_sentence":"引き継ぎ内容の抜けを事前に見つけるチェックツール","purpose_line_ja":"引き継ぎの抜けを見つけやすくするためのツールです。","use_case_line_ja":"休み前や交代前に渡す内容を確かめたい時に使います。","how_it_works_line_ja":"引き継ぎ項目を入れると、不足しやすい観点が分かります。","core_action":"check","family":"handoff_gap_check","mechanic":"filter_toggle","input_style":"listing_cards","output_style":"choice_cards","output_label":"ここを見ればOKです","audience_promise":"渡す前に不足項目を洗い出せる。","publish_hook":"引き継ぎ項目を自分で追加・編集すると、不足しやすい観点が横で警告されて抜けを先に見つけられる。","engine":"brief_driven","interaction_archetype":"filter_toggle","page_archetype":"choice_rack","ui_variant":"filter","intro_variant":"filter_strip","interaction_model":"toggle_filter_pills","primary_layout":"filter_bar_with_survivor_wall","result_presentation_style":"alive_dead_listing_cards","palette_motif":"物件ブルー","main_cta":"部屋探しの条件で試す","input_panel_title":"条件を切り替える","sample_panel_title":"部屋探しの条件で試す","guide_panel_title":"絞り込みの見どころ","hero_panel_label":"残る候補","output_shape":"choice_rack","state_model":"filter_toggle_state","core_loop":"listing_cards -> filter_toggle -> choice_cards","component_pack":"choice_rack+choice_cards","scaffold_id":"brief_canvas","single_shot_text_generator":false};
